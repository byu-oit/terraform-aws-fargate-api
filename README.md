...
```hcl
module "my_app" {
  source                       = "github.com/byu-oit/terraform-aws-fargate-api?ref=v6.5.0"
...
| health_check_port                 | number                                      | The port for the health check. Defaults to the traffic/container port.                                                                                                                                                                                                                                                                                                                               | <container_port>                                                                       |
...
* **`ports`** - (Required) a list of ports this container is listening on. **Be sure to include the `container_port` AND `health_check_port` (if applicable)**.
