...
```hcl
module "my_app" {
  source                       = "github.com/byu-oit/terraform-aws-fargate-api?ref=v6.0.3"
...
| lb_idle_timeout                   | number                                      | The time in seconds that the connection is allowed to be idle. Defaults to 60 seconds.                                                                                                                                                                                                                                                                                                               |
